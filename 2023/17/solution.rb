# I don't want to deal with imports for this thing
# https://github.com/kanwei/algorithms/blob/master/lib/containers/heap.rb#L38
=begin rdoc
...
class Heap
  ...
  # is given.
  def initialize(ary=[])
    # I change the compare function to work with my tuples
    @compare_fn = lambda { |x, y| (x[0] <=> y[0]) == -1 }
    @next = nil
    @size = 0
    @stored = {}
